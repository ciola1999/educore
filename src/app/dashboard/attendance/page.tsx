...
import { DailyLogView } from "@/components/attendance/daily-log-view"; // ✅ Import komponen baru
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <Tabs defaultValue="scan" className="space-y-8">
        <TabsList className="bg-zinc-900/50 border border-zinc-800 p-1 h-14 rounded-2xl w-full flex overflow-x-auto scrollbar-none justify-start sm:justify-center gap-2">
          ...
          {/* ✅ Tab Baru untuk Daily Log */}
          <TabsTrigger
            value="daily-log"
            className="rounded-xl px-6 whitespace-nowrap text-zinc-500 data-[state=active]:bg-indigo-600 data-[state=active]:text-white transition-all gap-2"
          >
            <History className="h-4 w-4" /> Daily Log
          </TabsTrigger>
          <TabsTrigger
            value="manual"
        ...
        {/* ✅ Konten Tab Baru untuk Daily Log */}
        <TabsContent
          value="daily-log"
          className="animate-in fade-in slide-in-from-bottom-4 duration-500 outline-none"
        >
